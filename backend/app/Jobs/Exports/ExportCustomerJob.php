...
class ExportCustomerJob extends BaseExportJob
{
    ...
    protected function buildExport(Export $export): BaseExport
    {
        ...
        return new CustomerExport($query, $title, $metaLines, $columns);
    }
    ...
    protected function onCompleted(Export $export): void
    {
        ...
        app(CustomerAuditLogger::class)->customerExported(
            $user,
            $businessId,
            $storeId,
            $export,
    ...
    private function resolveScope(Export $export): array
    {
        ...
        $title = $storeId
            ? __('exports.of_store', ['label' => __('exports.label_customers'), 'name' => Store::find($storeId)?->name ?? ''])
            : __('exports.of_business', ['label' => __('exports.label_customers'), 'name' => $businessName]);
