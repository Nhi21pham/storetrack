...
class ExportProductCategoryJob extends BaseExportJob
{
    public const TYPE = 'product-categories';
    ...
    protected function buildExport(Export $export): BaseExport
    {
        ...
        return new ProductCategoryExport($query, $title, $metaLines, $columns);
    }
    ...
    protected function filename(Export $export): string
    {
        ...
        return "product-categories-{$slug}-{$datetime}.xlsx";
    }
    ...
    protected function onCompleted(Export $export): void
    {
        ...
        app(ProductCategoryAuditLogger::class)->productCategoryExported(
            $user,
            $storeId,
            $export,
            $metadata['scope_name'] ?? '',
