...
const {
  ...
  sortedInvoices, supplierOptions, sort,
...
watch([searchQuery, statusFilter, methodFilter, supplierFilter, startDate, endDate, () => sort.sortCriteria.value], resetPage, { deep: true })
