  ...
  <div class="modal-overlay" @click.self="$emit('close')">
    <div class="modal">
      <div class="modal-header">
        <h2>{{ $t('suppliers.detailsTitle') }}</h2>
      ...
      <div class="modal-body">
        <div class="detail-row">
          <span class="detail-label">{{ $t('suppliers.idLabel') }}</span>
          <span class="detail-value mono">#{{ supplier.id }}</span>
        </div>

        <div class="detail-row">
          <span class="detail-label">{{ $t('suppliers.name') }}</span>
          <span class="detail-value name-text">{{ supplier.name }}</span>
        </div>

        <div class="detail-row">
          <span class="detail-label">{{ $t('suppliers.taxCode') }}</span>
